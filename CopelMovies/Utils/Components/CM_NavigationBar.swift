...
public protocol CM_NavigationBarDelegate {
    func buttonTapped()
    func backTapped()
}

open class CM_NavigationBar: UIView {
    
    var delegate: CM_NavigationBarDelegate?
    ...
    public func buildComponents(titleText: String, textColor: UIColor = .white, delegate: CM_NavigationBarDelegate, backDisabled: Bool = true) {
